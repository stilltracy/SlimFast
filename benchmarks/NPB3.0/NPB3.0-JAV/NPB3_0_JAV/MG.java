...
public class MG extends MGBase{
  ...
  public static void shutdownWorkers(MGBase[] workers)
  {
  ...
  {
	shutdownWorkers(interp);
	shutdownWorkers(psinv);
	shutdownWorkers(rprj);
	shutdownWorkers(resid);
  }
