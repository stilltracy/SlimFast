...
public class DupKeyData {
    ...
    public static byte[] combine(final byte[] key,
        ...
        ArrayCopy.copy(key, keyOff, buf, 0, keySize);
        ArrayCopy.copy(data, dataOff, buf, keySize, dataSize);
        final int nextOff =
    ...
    public static void split(final byte[] twoPartKey,
        ...
        if (paramKey != null) {
            ...
            ArrayCopy.copy(twoPartKey, 0, keyBuf, 0, keySize);
        ...
        if (paramData != null) {
            ...
            ArrayCopy.copy(twoPartKey, keySize, dataBuf, 0, dataSize);
    ...
    public static byte[] makePrefixKey(
        ...
        ArrayCopy.copy(key, 0, buf, 0, keySize);
    ...
    public static byte[] getKey(final byte[] buf, int off, int len) {
        ...
        ArrayCopy.copy(buf, off, key, 0, keyLen);
    ...
    public static byte[] getData(final byte[] buf, int off, int len) {
       ...
       ArrayCopy.copy(buf, off + keyLen, data, 0, dataLen);
       return data;
    }
    ...
    public static class TwoPartKeyComparator implements Comparator<byte[]> {
        ...
        public int compare(final byte[] twoPartKey1,
            ...
            if (btreeComparator == null) {
                ...
                ArrayCopy.copy(twoPartKey1, 0, key1, 0, keySize1);
                ArrayCopy.copy(twoPartKey2, 0, key2, 0, keySize2);
            ...
            if (duplicateComparator == null) {
                ...
                ArrayCopy.copy(twoPartKey1, keySize1, data1, 0, dataSize1);
                ArrayCopy.copy(twoPartKey2, keySize2, data2, 0, dataSize2);
    ...
    public static int compareMainKey(
        ...
        if (btreeComparator == null) {
            ...
            final byte[] key1 = new byte[keySize1];
            final byte[] key2 = new byte[keySize2];
            ArrayCopy.copy(keyBytes1, 0, key1, 0, keySize1);
            ArrayCopy.copy(keyBytes2, keyOff2, key2, 0, keySize2);
            keyCmp = btreeComparator.compare(key1, key2);
        }
        return keyCmp;
    }
