...
class SubscriptionThread extends StoppableThread {
    ...
    SubscriptionThread(ReplicatedEnvironment env,
        ...
        super(RepInternal.getRepImpl(env), "Subscription Main");
            ...
            if (messageProcThread.isAlive()) {
                try {
                    ...
                    LoggerUtils.fine(logger, envImpl,
                                     ...
                                     "thread " + e1.getMessage());
                }
            }
            storedException = e;
            LoggerUtils.info(logger, envImpl, "received group shutdown " +
                                              e.getMessage());
    ...
    private void loopInternal()
        ...
        try {
            ...
            while (true) {
                ...
                assert TestHookExecute.doHookIfSet(exceptionHandlingTestHook, this);
