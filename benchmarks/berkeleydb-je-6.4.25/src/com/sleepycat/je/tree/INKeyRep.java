...
public abstract class INKeyRep
    ...
    public static class Default extends INKeyRep {
        ...
        public byte[] getFullKey(
            ...
            ArrayCopy.copy(prefix, 0, key, 0, prefixLen);
            ArrayCopy.copy(suffix, 0, key, prefixLen, suffixLen);
        ...
        public INKeyRep copy(int from, int to, int n, IN parent) {
            ArrayCopy.copy(keys, from, keys, to, n);
            return this;
        }
    ...
    public static class MaxKeySize extends INKeyRep {
        ...
        public INKeyRep set(int idx, byte[] key, IN parent) {
            ...
            ArrayCopy.copy(key, 0, keys, slotOff, key.length);
        ...
        public byte[] get(int idx) {
            ...
            ArrayCopy.copy(keys, slotOff, info, 0, slotLen);
            return info;
        }
        ...
        public byte[] getKey(int idx, boolean embeddedData) {
            ...
            ArrayCopy.copy(keys, slotOff, key, 0, slotLen);
            return key;
        }
        ...
        public byte[] getFullKey(
            ...
            ArrayCopy.copy(prefix, 0, key, 0, prefixLen);
            ArrayCopy.copy(keys, slotOff, key, prefixLen, suffixLen);
            return key;
        }
        ...
        @Override
        public INKeyRep copy(int from, int to, int n, IN parent) {
            ArrayCopy.copy(keys, (from * fixedKeyLen),
                             keys, (to * fixedKeyLen),
                             n * fixedKeyLen);
            return this;
        }
