...
public final class Key implements Comparable<Key> {
    ...
    public Key(byte[] key) {
        if (key == null) {
            ...
            ArrayCopy.copy(key, 0, this.key, 0, key.length);
        }
    }
    ...
    public static byte[] makeKey(DatabaseEntry dbt) {
        ...
        if (entryKey == null) {
            ...
            ArrayCopy.copy(entryKey, dbt.getOffset(), newKey,
                             0, dbt.getSize());
            return newKey;
        }
    }
    ...
    public static int compareKeys(byte[] key1,
        ...
        if (off1 != 0 || len1 != key1.length) {
            ...
            ArrayCopy.copy(key1, off1, b, 0, len1);
            key1 = b;
        }
        if (off2 != 0 || len2 != key2.length) {
            final byte[] b = new byte[len2];
            ArrayCopy.copy(key2, off2, b, 0, len2);
            key2 = b;
        }
    ...
    public static byte[] createKeyPrefix(byte[] key1, byte[] key2) {
        ...
        ArrayCopy.copy(key1, 0, ret, 0, len);
