...
public class DbCacheSize {
    ...
    private void setKeyData(final byte[] keyBytes,
        ...
        ArrayCopy.copy(keyBytes, 0, fullKey, keyOffset, keyBytes.length);
        ...
        if (duplicates) {
            ...
            ArrayCopy.copy(fullKey, 0, finalKey, 0, keySize);
            ArrayCopy.copy(fullKey, keySize, finalData, 0, dataSize);
        } else {
            finalKey = fullKey;
    ...
    private byte[] padLeft(byte[] data, int size) {
        ...
        ArrayCopy.copy(data, 0, b, size - data.length, data.length);
        return b;
    }
