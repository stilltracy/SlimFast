...
public class CheckReverseSplitsTest extends CheckBase {
    ...
    private void setupReverseSplit(Database db)
        ...
        Trace.trace(DbInternal.getEnvironmentImpl(env), "After deletes");
        ...
        env.compress();
        Trace.trace(DbInternal.getEnvironmentImpl(env), "After compress");
        ...
        Trace.trace(DbInternal.getEnvironmentImpl(env), "After data setup");
