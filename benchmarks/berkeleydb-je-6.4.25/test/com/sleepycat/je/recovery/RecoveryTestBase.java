...
public class RecoveryTestBase extends TestBase {
    ...
    protected void closeEnv()
        ...
        TestUtils.validateNodeMemUsage(DbInternal.getEnvironmentImpl(env),
                                      false);
    ...
    private List<StartupTracker> 
        ...
        infoList.add
            (DbInternal.getEnvironmentImpl(env).getStartupTracker());
    ...
    protected void verifyData(Map<TestData, Set<TestData>> expectedData,
        ...
        for (int d = startDb; d < endDb; d++) {
            ...
            DbInternal.getEnvironmentImpl(env).verifyCursors();
            int numSeen = 0;
