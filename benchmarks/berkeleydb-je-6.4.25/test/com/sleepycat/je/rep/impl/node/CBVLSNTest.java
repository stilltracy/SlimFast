...
public class CBVLSNTest extends RepTestBase {
    ...
    private void setupConfig(boolean allowCleaning) {
        ...
        for (RepEnvInfo i : repEnvInfo) {
            ...
            /* Disable REPLAY_COST_PERCENT as well to remove variability. */
            i.getRepConfig().setConfigParam(
                RepParams.REPLAY_COST_PERCENT.getName(), "0");
    ...
    public void testNewNodeThrottle() 
        ...
        setupConfig(true /*allowCleaning*/);
        createGroup();
    ...
    private VLSN workAndCheckLocalCBVLSN(ReplicatedEnvironment mRepEnv,
        ...
        for (int i=0; i < numRecords; i++) {
            ...
            if (logFileNum < newFileNum) {
                ...
                if (verbose) {
                    System.out.println(
                        "master's global CBVLSN = " + mNode.getGroupCBVLSN() +
    ...
    private void doGroupWideChecks(ReplicatedEnvironment mRepEnv,
        ...
        for (RepEnvInfo repi : repEnvInfo) {
             ...
             */
            while (true) {
                VLSN groupCBVLSN = repNode.getGroupCBVLSN();
                VLSN groupMasterCBVLSN = mNode.getGroupCBVLSN();
